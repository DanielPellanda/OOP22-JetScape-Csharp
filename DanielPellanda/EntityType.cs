...
namespace JetScape.DanielPellanda
{
    public class EntityType
    {
        ...
        private Type value = (Type) EntityType.UNDEFINED;

        public static IList<EntityType> ALL_ENTITY_TYPE = new List<EntityType>() { 
            EntityType.PLAYER, EntityType.ZAPPER, EntityType.MISSILE, EntityType.SHIELD, EntityType.TELEPORT, EntityType.COIN };
